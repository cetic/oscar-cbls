...
/**
 * NQueens for larger problems :
 * - queens are always on different rows
 * - neighborhood is queen swap
 * - first queen is among most violated ones; maintained through invariant
...
object NQueensBench extends LinearSelectorClass(true) with StopWatch {
  ...
  val help = "Benchmarking NQueens \n" +
    ...
    "if four parameters: nQueens nRuns random dryRun (they must all be present)\n" +
    "example: 50000 10 0 0\n" +
    "nQueens is the number of queens to test\n" +
    "nRuns is the number of time this should be tested\n" +
