...
/** Companion object of the [[InsertPointInsertionPointFirst]] class. */
object InsertPointInsertionPointFirst {
  ...
  def apply(
    ...
    name: String = "InsertPointInsertionPointFirst",
  ...
  ) = new InsertPointInsertionPointFirst(
    vrs,
    insertionAfterNodes,
...
/** Neighborhood which inserts a new value in a sequence. It first selects the insertion point and
  ...
  *   Set the use of a [[oscar.cbls.algo.search.HotRestart]] mechanism.
  */
class InsertPointInsertionPointFirst(
  vrs: VRS,
  insertionAfterNodes: () => Iterable[Int],
  relevantNodesToInsert: Int => Iterable[Int],
  name: String,
  ...
  override protected def exploreNeighborhood(exploration: Exploration[InsertPointMove]): Unit = {
    ...
    val iterationScheme =
      if (hotRestart) HotRestart(insertionAfterNodes(), pivot)
      else insertionAfterNodes()
  ...
  override def reset(): Unit = {
    ...
    val insertPoints = insertionAfterNodes()
