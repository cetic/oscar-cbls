...
/** Factory for [[RandomizeRoutes]] */
object RandomizeRoutes {
  ...
  def apply(vrs: VRS, generateRandomRoute: () => IntSequence, numTriesWithoutImprovement: Int = 1) =
    new RandomizeRoutes(vrs, generateRandomRoute, numTriesWithoutImprovement)
  ...
  def shuffle(
    ...
    RandomizeRoutes(vrs, generateRandomRoute, numTriesWithoutImprovement)
  }
