...
object ProfilingTableNode{
  ...
  def apply(profiler: SearchProfiler, parent: Option[ProfilingTableBranchNode], rowPrefix: Array[String]): ProfilingTableNode ={
...
abstract class ProfilingTableNode(val profiler: SearchProfiler, parent: Option[ProfilingTableBranchNode], rowPrefix: Array[String]){
