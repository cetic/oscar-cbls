...
package oscar.cbls.test.lib.invariant.routing.genericConstraint
...
import oscar.cbls.lib.invariant.routing.abstractGenericConstraint.BackwardNaiveRoutingConstraint
