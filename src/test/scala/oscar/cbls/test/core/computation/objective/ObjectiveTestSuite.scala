...
//        val expl = obj.newExploration[DummyMove](new DummySimpleNeighborhood().searchProfiler())
...
//      override def newExploration[M1 <: Move](neighborhood: SimpleNeighborhood[M1]): Exploration[M1] =
//        new Exploration(objValue.value(), None) {
//
...
//
//              override def newExploration[M2 <: Move](neighborhood: SimpleNeighborhood[M2]): Exploration[M2] =
...
class TestAssignValueNeighborhood(variable: IntVariable, value: Long)
    extends SimpleNeighborhood[TestAssignValueNeighborhoodMove]("TestAssign") {

  override def exploreNeighborhood(exploration: Exploration[TestAssignValueNeighborhoodMove]): Unit = {
  ...
  override def doMove(move: TestAssignValueNeighborhoodMove): Unit = {
    move match {
