 ...
 * @param otherValues
 */
class ObjectiveFunctionDisplayV2(title: String, minCap:Long, maxCap:Long, basePercentile: Int, otherValues: List[String])
...
object ObjectiveFunctionDisplayV2{
  def apply(title: String, minCap: Long, maxCap:Long, percentile: Int, otherValues: List[String]): ObjectiveFunctionDisplayV2 =
    new ObjectiveFunctionDisplayV2(title, minCap, maxCap, percentile, otherValues)
}
