 ...
 */
class ShowObjectiveFunction(a: Neighborhood, obj: () => Long, title: String = "Objective function vs. time[s]", cap:Long = Long.MaxValue, percentile:Option[Double] = None) extends NeighborhoodCombinator(a){
