...
case class Store(override val verbose:Boolean = false,
  ...
  private var allObjectives:List[Objective] = Nil
  private var nbObjectives = 0
  def registerObjective(obj:Objective):Int = {
  ...
  private var globalObjectiveArray:Array[Objective] = _
  ...
  def getObjective(id:Int):Objective = globalObjectiveArray(id)
}
