...
final case class SearchCompleted[ResultType](uniqueSearchID: Long,
                                             ...
                                             durationMS: Int) extends SearchEnded

final case class SearchAborted(uniqueSearchID: Long) extends SearchEnded

final case class SearchCrashed(uniqueSearchID: Long,
                               searchTask: Option[RemoteTaskIdentification],
                               exception: Throwable,
                               worker: ActorRef[MessageToWorker]) extends SearchEnded
